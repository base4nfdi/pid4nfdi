...
sections:
  ...
  - block: markdown
    content:
      ...
      text: |
        <br> 
        <span style="font-size: 1.5rem; text-align: center; display: block;"> The PID Coordination Hub serves as a centralized infrastructure for managing persistent identifiers (PIDs) within Germany’s National Research Data Infrastructure (NFDI). </span>
         <br> 
